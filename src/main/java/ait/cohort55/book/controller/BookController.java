...
public class BookController{
    ...
    public Iterable<BookDto> findAllBooksByAuthor(@PathVariable String authorName) {
        return bookService.findAllBooksByAuthor(authorName);
    }

    @GetMapping("/books/publisher/{publisherName}")
    public Iterable<BookDto> findAllBooksByPublisher(@PathVariable String publisherName) {
        return bookService.findAllBooksByPublisher(publisherName);
    }
    ...
    @GetMapping("/publishers/books/{authorName}")
    public Iterable<String> findPublisherByAuthor(@PathVariable String authorName) {
        return bookService.findPublisherByAuthor(authorName);
    }
